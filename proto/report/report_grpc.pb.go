...
const (
	Reporter_ReportFinal_FullMethodName = "/report.Reporter/ReportFinal"
)
...
type ReporterClient interface {
	ReportFinal(ctx context.Context, in *FinalCount, opts ...grpc.CallOption) (*Ack, error)
}
...
func (c *reporterClient) ReportFinal(ctx context.Context, in *FinalCount, opts ...grpc.CallOption) (*Ack, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Ack)
	err := c.cc.Invoke(ctx, Reporter_ReportFinal_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ReporterServer interface {
	ReportFinal(context.Context, *FinalCount) (*Ack, error)
...
func (UnimplementedReporterServer) ReportFinal(context.Context, *FinalCount) (*Ack, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReportFinal not implemented")
}
...
func _Reporter_ReportFinal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FinalCount)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReporterServer).ReportFinal(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Reporter_ReportFinal_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReporterServer).ReportFinal(ctx, req.(*FinalCount))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Reporter_ReportFinal_Handler,
		},
	},
